...
# Pass your complete prompt — the script is a dumb pipe to an external LLM.
#
# Usage:
#   peer-review.sh "<prompt>"
#   echo "<prompt>" | peer-review.sh
#
...
if [[ -z "$PROMPT" ]]; then echo "Usage: peer-review.sh \"<prompt>\" or pipe via stdin" >&2; exit 1; fi
